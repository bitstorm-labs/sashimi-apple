...
/// master.
final class HLSMultivariantPlaylistTests: XCTestCase {
    private let multivariantURL = URL(string: "http://jellyfin.test:8096/videos/abc/master.m3u8?DeviceId=DEV&ApiKey=REDACTED")!
    ...
    func testHDRCopyPlaylistPinsTheCopyVariant() {
    ...
    func testImageStreamIsNotAVariant() {
        let variants = HLSMultivariantPlaylist.variants(in: hdrCopyPlaylist)
    ...
    func testSingleVariantPlaylistIsLeftAlone() {
        let playlist = """
        #EXTM3U
        ...
        """
        XCTAssertNil(HLSMultivariantPlaylist.singlePrimaryVariantURL(playlist: playlist, multivariantURL: multivariantURL))
    }
    ...
    func testForcedReencodePlaylistIsLeftAlone() {
        let playlist = """
        #EXTM3U
    ...
    func testDolbyVisionPlaylistPinsTheFirstPrimary() {
        let playlist = """
        #EXTM3U
        ...
        """
        let pinned = HLSMultivariantPlaylist.singlePrimaryVariantURL(playlist: playlist, multivariantURL: multivariantURL)
